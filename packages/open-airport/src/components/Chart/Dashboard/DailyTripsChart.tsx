...
export const DailyTripsChart: React.FC<DashboardChartProps> = ({
  yesterdaysAggregate,
  todaysAggregate,
  dimensions
}: DashboardChartProps) => {
  ...
  const chartData = [
    {
      day: 'Yesterday',
      trips: yesterdaysAggregate.measures['airport.trips.count'] || 0
    },
    {
      day: 'Today',
      trips: todaysAggregate.measures['airport.trips.count'] || 0
    }
  ]
